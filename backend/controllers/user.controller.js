...
//         sameSite: "None", // Important for frontend on a different domain
...
export const register = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "Register failed. Please try again later.", success: false });
  }
};
...
export const login = async (req, res) => {
  try {
    ...
    console.error("Login Error:", error);
    return res.status(500).json({ message: "Login failed. Please try again later.", success: false });
  }
};
