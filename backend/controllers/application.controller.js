...
export const applyJob = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "Error while applying for the job.", success: false });
  }
};
...
export const getApplicants = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "Error fetching applicants.", success: false });
  }
};
...
export const updateStatus = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "Error updating application status.", success: false });
  }
};